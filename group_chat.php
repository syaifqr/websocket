            ...
            success: function(data, status) {
                ...
                for (let e in message) {
                    ...
                    let contain = '<div class=" ' +
                        styleBox2 +
                        ' "><div class="mb-[10px] relative max-w-fit ' +
                        styleBox +
                ...
                conn.onmessage = function(e) {
                    ...
                    if (data.from == "Me") {
                        styleBox =
                            'relative max-w-none px-4 py-2 text-gray-700 rounded-xl shadow bg-red-200 text-right';
                        styleBox2 = 'justify-end';
                        styleBox3 = 'text-right';
                        styleBox4 = 'ml-[150px]';
                    } else {
                        styleBox =
                            'relative max-w-none px-4 py-2 text-gray-700 bg-green-200 rounded-xl shadow';
